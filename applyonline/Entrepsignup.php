...
if(isset($_POST['btns_save'])){
    ...
    $sql= "INSERT INTO entreplogin_users values(default,'$firstname', '$lastname','$middlename', '$email', '$locations','$occupation','$birthday' ,'$gender')";
...
?>
<div class="cont_ord">
    <font size="6" color="#BCD905" ><legend> ENTREPRENUER  Department Sign up</legend></font>
